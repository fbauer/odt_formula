...
testcases = [
   ...
   (u"['Sheet1'.B4:.B5]", (u"reference",
                           (None,
                            (((u'string', "Sheet1"), ('string', 'B'), (u'integer', 4)),
                             (None, ('string', 'B'), (u'integer', 5)))))),
    (u"['Sheet1'.B:.B]", (u"reference",
                          (None,
                           (((u'string', "Sheet1"), ('string', 'B'), None),
                            (None, ('string', 'B'), None))))),
    (u"['Sheet1'.4:.5]", (u"reference",
                          (None,
                           (((u'string', "Sheet1"), None, (u'integer', 4)),
                            (None, None, (u'integer', 5)))))),

    (u"['Sheet1'.B4:'Sheet1'.B5]", (u"reference",
                           (None,
                            (((u'string', "Sheet1"), ('string', 'B'), (u'integer', 4)),
                             ((u'string', "Sheet1"), ('string', 'B'), (u'integer', 5)))))),
    (u"['Sheet1'.B:'Sheet1'.B]", (u"reference",
                          (None,
                           (((u'string', "Sheet1"), ('string', 'B'), None),
                            ((u'string', "Sheet1"), ('string', 'B'), None))))),
    (u"['Sheet1'.4:'Sheet1'.5]", (u"reference",
                          (None,
                           (((u'string', "Sheet1"), None, (u'integer', 4)),
